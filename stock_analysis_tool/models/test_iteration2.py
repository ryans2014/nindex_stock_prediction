...
@utility.named_model
def cnn_multi_input_mse_v2_basic():
...
@utility.multi_input_model
@utility.named_model
def cnn_multi_input_mse_v2_deep():
...
@utility.multi_input_model
@utility.named_model
def lstm_multi_input_mse_v2_basic():
...
@utility.multi_input_model
@utility.named_model
def lstm_multi_input_mse_v2_stack4():
...
test_iteration2_mse = [cnn_multi_input_mse_v2_basic,
                       cnn_multi_input_mse_v2_deep,
                       lstm_multi_input_mse_v2_basic,
                       lstm_multi_input_mse_v2_stack4]
